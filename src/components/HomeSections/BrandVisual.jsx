...
//   return (
//     <div>
//         <h1 className='text-center text-black font-bold'>This is <span className='text-amber-600 font-extrabold'>Brand Visual</span> Page</h1>
//     </div>
//   )
// }
...
import StudioMainImg from '../../assets/Images/glassitem.webp'; 
  ...
  return (
    ...
    <div className="bg-white min-h-screen pt-24 pb-20 overflow-x-hidden">
      <div className="max-w-430 mx-auto px-4 md:px-8 lg:px-15">
        ...
        >
          <div className="w-full h-125 md:h-175 lg:h-220 overflow-hidden">
             <img 
               src={StudioMainImg} 
               alt="Studio Session"
        ...
        <div className="space-y-20 lg:space-y-32 max-w-300">
          ...
          <div data-aos="fade-right" className="space-y-6 mb-8">
            ...
            <p className="text-[#1a1a1a] text-[16px] md:text-[16px] leading-6 font-normal opacity-90 text-justify md:text-left">
